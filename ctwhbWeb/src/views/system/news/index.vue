...
import { NewsApi, NewsVO } from '@/api/system/news'
...
const getList = async () => {
  loading.value = true
  try {
    const data = await NewsApi.getNewsPage(queryParams)
