  ...
  <ContentWrap>
    ...
    >
      ...
      <el-form-item label="分类" prop="classify">
        ...
        >
          <el-option
            v-for="dict in getIntDictOptions(DICT_TYPE.FORUM_CLASSIFY)"
            :key="dict.value"
            :label="dict.label"
            :value="dict.value"
          />
      ...
      <el-form-item>
        ...
        <el-button
          ...
          v-hasPermi="['system:forum:create']"
        >
  ...
  <ContentWrap>
    <el-table v-loading="loading" :data="list" :stripe="true" :show-overflow-tooltip="true">
      ...
      <el-table-column label="分类" align="center" prop="classify">
        <template #default="scope">
          <dict-tag :type="DICT_TYPE.FORUM_CLASSIFY" :value="scope.row.classify" />
        </template>
      </el-table-column>
      ...
      <el-table-column label="操作" align="center" min-width="120px">
        <template #default="scope">
          <el-button
            ...
            v-hasPermi="['system:forum:update']"
          >
            编辑
          </el-button>
          <el-button
            ...
            v-hasPermi="['system:forum:delete']"
          >
            删除
          </el-button>
        </template>
...
import { ForumApi, ForumVO } from '@/api/system/forum'
